...
table1 <- CreateTableOne(vars = listVars, data = data_stripped, factorVars = catVars, 
                         strata=c("NASH_01"))
table1
```
...
# title:
cat(html("<b>Table 1a.</b> Inflammation vs. No-Inflammation among Children with NAFLD", "p"), 
    file = "table1b.html")
...
# title:
cat(html("<b>Table 1b.</b> NAS Score &lt;3 vs. NAS Score &ge;3 among Children with NAFLD", "p"), 
    file = "table1c.html")
